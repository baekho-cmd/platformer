 ...
 // Stage 13: wall challenge
{
  start: { x: 100, y: H-200 },
  platforms: [
    new Rect(0,H-40,W,40),
    new Rect(200,H-200,100,20),
    new Rect(600,H-200,100,20),
    new Rect(800,H-300,80,20)
  ],
  walls: [
    new Rect(340,H-200,20,120),
    new Rect(540,H-240,20,140),
    new Rect(740,H-200,20,140)
  ],
  redBlocks: [
    { x: 460, y: H-240, w: 80, h: 40 }
  ],
  finish: new Rect(860, H-340, 24, 24)
},
...
function loadStage(i, resetTimer = true){
  if(resetTimer){
    timerStopped = false;
    stageStartTime = performance.now();
